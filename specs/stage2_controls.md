# Stage 2 controls — P1–N2 literature binders through AF2 (cycle 1 contract)

> **Real-designs pipeline (Stage 1 outputs → MPNN → AF2 fan-in) is a
> separate contract: see [`specs/stage2_proteinmpnn_af2.md`](stage2_proteinmpnn_af2.md).**
> This file preserves the cycle 1 controls contract verbatim. The two
> pipelines share `workflow/scripts/run_proteinmpnn.py`,
> `run_colabfold.py`, and `compute_metrics.py` as validated drivers, but
> their orchestrators and halt gates are independent.
